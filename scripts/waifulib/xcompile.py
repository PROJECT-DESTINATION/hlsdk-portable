...
def configure(conf):
	if conf.options.ANDROID_OPTS:
		...
		conf.env.cxxshlib_PATTERN = "%s.sprx"
		conf.env.cxxshlib_ps3_PATTERN = "%s.sprx"
		conf.env.cshlib_PATTERN = "%s.sprx"
		conf.env.cshlib_ps3_PATTERN = "%s.sprx"
		conf.env.cprogram_PATTERN = "%s.self"
		conf.env.cxxprogram_PATTERN = "%s.self"

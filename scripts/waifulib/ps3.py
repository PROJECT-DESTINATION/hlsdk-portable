...
class cxx_ps3(cxx.cxx):
	run_str = '${SNC} ${ARCH_ST:ARCH} -Xstd=cpp11 ${CXXFLAGS} ${FRAMEWORKPATH_ST:FRAMEWORKPATH} -I"." ${SNCPATH_ST:INCPATHS} ${DEFINES_ST:DEFINES} ${SNC_SRC_F}${SRC} ${SNC_TGT_F}${TGT[0].abspath()} ${CPPFLAGS}'

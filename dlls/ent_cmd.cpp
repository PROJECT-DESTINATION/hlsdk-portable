...
===== ent_cmd.cpp ========================================================
  ...
  goldsrc equiv of various source console command entities

*/

//TODO: cvar that replicates the behavior of "sv_allow_point_server_command" from tf2 (i tried this myself and it just broke, maybe im just dumb)
